...
export default function Home() {
  ...
  return <div className="min-h-screen bg-[#FAFAF8] text-[#1A1F3C]">
    <PublicNav />
    <main>
      <section className="relative overflow-hidden border-b border-[#E8E6E2]">
        ...
        <div className="relative mx-auto grid min-h-[calc(100vh-5rem)] max-w-7xl items-center gap-14 px-6 pb-20 pt-32 lg:grid-cols-[.92fr_1.08fr] lg:px-10">
          <AnimatedSection animation="slide-up"><div className="max-w-xl"><p className="sn-label mb-6 text-[#6B7FBF]">Enterprise intelligence platform</p><h1 className="sn-display max-w-[36rem] text-[clamp(3.2rem,7vw,6.5rem)] leading-[.94]">Intelligence,<br /><span className="text-[#6B7FBF]">without the</span><br />complexity.</h1><p className="mt-8 max-w-lg text-lg leading-relaxed text-[#6B6660]">SOPRANOVA connects enterprise data, AI, analytics, and automation into one intelligent operating layer.</p><div className="mt-10 flex flex-wrap gap-3"><Link to="/platform" className="inline-flex items-center gap-2 rounded-xl bg-[#1A1F3C] px-5 py-3 text-sm font-medium text-[#FAFAF8] transition hover:-translate-y-0.5 hover:bg-[#252B4A] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#6B7FBF]">Explore the platform <ArrowUpRight size={16} /></Link><Link to="/contact" className="inline-flex items-center gap-2 rounded-xl border border-[#D4D1CB] px-5 py-3 text-sm font-medium text-[#1A1F3C] transition hover:-translate-y-0.5 hover:border-[#1A1F3C] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#6B7FBF]">Talk to an expert</Link></div><div className="mt-12 flex items-center gap-3 text-xs text-[#8C887F]"><span className="grid h-7 w-7 place-items-center rounded-full bg-[#EEF6F6] text-[#4A8B8C]"><Check size={14} /></span>Built for governed, traceable decisions</div></div></AnimatedSection>
          <AnimatedSection animation="scale" delay={150}><HeroVideo /></AnimatedSection>
        </div>
      </section>
