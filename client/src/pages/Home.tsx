...
function HeroVisual() {
  ...
  useEffect(() => {
    ...
    function draw() {
      ...
      ctx.fillStyle = "rgba(107, 127, 191, 0.7)";
      ctx.fill();
...
const capabilities = [
  { label: "AI", desc: "Conversational intelligence across your entire enterprise data landscape." },
  { label: "Analytics", desc: "Real-time insights that surface patterns invisible to conventional tools." },
  { label: "Agents", desc: "Autonomous AI agents that act, decide, and learn from your workflows." },
    ...
    <div className="min-h-screen bg-sn-white">
      ...
      <section className="relative min-h-screen flex items-center overflow-hidden">
        <div
          ...
          style={{
            background: "radial-gradient(ellipse 80% 60% at 50% 40%, rgba(107,127,191,0.06) 0%, transparent 70%)",
          }}
        />
        <HeroVisual />
        ...
        >
          <div className="max-w-3xl">
            ...
            <h1
              ...
              style={{ fontSize: "clamp(2.75rem, 6vw, 5rem)", color: "#1A1F3C" }}
            >
              Intelligence,<br />
            ...
            <p
              ...
              style={{ fontSize: "1.125rem", color: "#6B6660" }}
            >
              SOPRANOVA connects enterprise data, AI, analytics, and automation
              into one intelligent platform. Power that feels effortless.
            </p>
            <div className="flex flex-wrap gap-4">
              <Link
                ...
                onMouseEnter={(e) => {
                  e.currentTarget.style.background = "#252B4A";
                  e.currentTarget.style.transform = "translateY(-2px)";
                  e.currentTarget.style.boxShadow = "0 8px 24px rgba(26,31,60,0.18)";
                }}
                onMouseLeave={(e) => {
                  e.currentTarget.style.background = "#1A1F3C";
              ...
              <Link
                to="/contact"
                className="inline-flex items-center gap-2 px-6 py-3 rounded-xl text-sm font-medium transition-all duration-300 border"
                style={{ borderColor: "#D4D1CB", color: "#1A1F3C" }}
                onMouseEnter={(e) => {
                  e.currentTarget.style.borderColor = "#1A1F3C";
                  e.currentTarget.style.transform = "translateY(-2px)";
                }}
                onMouseLeave={(e) => {
                  e.currentTarget.style.borderColor = "#D4D1CB";
                  e.currentTarget.style.transform = "";
                }}
              >
                Talk to an Expert
          ...
          <div className="flex flex-col lg:flex-row gap-16">
              ...
              <div className="flex flex-col">
                {capabilities.map((cap, i) => (
                  <button
                    ...
                    style={{
                      borderColor: i === activeCapability ? "#6B7FBF" : "#E8E6E2",
                      borderBottomWidth: i === activeCapability ? "2px" : "1px",
                    }}
                    onClick={() => setActiveCapability(i)}
                    onMouseEnter={() => setActiveCapability(i)}
                  >
                    <div className="flex items-center justify-between">
                      <span className="text-sm font-medium" style={{ color: i === activeCapability ? "#1A1F3C" : "#8C887F" }}>
                        {cap.label}
                      </span>
                      <svg
                        width="16" height="16" viewBox="0 0 16 16" fill="none"
                        style={{
                          transform: i === activeCapability ? "rotate(0deg)" : "rotate(-90deg)",
                          transition: "transform 0.3s ease",
                          color: i === activeCapability ? "#6B7FBF" : "#B8B4AC",
                        }}
                      >
                    ...
                    <div
                      ...
                      style={{
                        maxHeight: i === activeCapability ? "80px" : "0",
                        opacity: i === activeCapability ? 1 : 0,
                        marginTop: i === activeCapability ? "8px" : "0",
                        color: "#6B6660",
            ...
            <div className="lg:w-1/2 flex items-center">
              <div
                ...
                style={{ background: "#F4F3F0", minHeight: 360 }}
              >
                <div
                  className="absolute inset-0 transition-all duration-700"
                  style={{
                    background: `radial-gradient(circle at ${30 + activeCapability * 12}% ${40 + activeCapability * 5}%, rgba(107,127,191,0.12) 0%, transparent 60%)`,
                  }}
                />
                <div className="relative">
                  <div className="sn-label mb-3">{capabilities[activeCapability].label}</div>
                  <div className="sn-display text-2xl mb-4" style={{ color: "#1A1F3C" }}>
                  ...
                  <div className="flex gap-2 mt-8">
                    {capabilities.map((_, i) => (
                      <div
                        ...
                        style={{
                          width: i === activeCapability ? 24 : 8,
                          background: i === activeCapability ? "#6B7FBF" : "#D4D1CB",
                        }}
                      />
                    ))}
                  </div>
      ...
      <section className="py-24 max-w-7xl mx-auto px-6">
        <AnimatedSection>
          <div className="text-center mb-16">
            ...
            <h2 className="sn-display" style={{ fontSize: "clamp(1.8rem, 3vw, 2.75rem)", color: "#1A1F3C" }}>
            ...
            <AnimatedSection key={item.step} delay={i * 80}>
              <div
                ...
                onMouseEnter={(e) => {
                  ...
                  (e.currentTarget as HTMLDivElement).style.background = "#ECEAE6";
                }}
                onMouseLeave={(e) => {
          ...
          <AnimatedSection>
            ...
            >
              <div
                ...
                style={{
                  background: "radial-gradient(ellipse 60% 80% at 50% 50%, rgba(107,127,191,0.15) 0%, transparent 70%)",
                }}
              />
              <div className="relative">
                <div className="sn-label mb-6" style={{ color: "rgba(248,246,242,0.4)" }}>
                  Ready to begin
                </div>
                <h2
                  className="sn-display mb-6"
                  style={{ fontSize: "clamp(1.8rem, 3.5vw, 3rem)", color: "#F8F6F2" }}
                >
                  This is what enterprise<br />intelligence should feel like.
                </h2>
                <p className="mb-10 text-sm" style={{ color: "rgba(248,246,242,0.55)" }}>
                  Join the enterprises that chose clarity over complexity.
                </p>
