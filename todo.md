...
- [ ] مزامنة آخر نسخة كاملة من SOPRANOVA إلى repository GitHub المرتبط والتحقق من branch والملفات المرفوعة.
- [ ] إعداد prompt عملي لـ OpenCode يشرح architecture والأوامر وقواعد التطوير وحالة الفيديوهات المؤجلة.
